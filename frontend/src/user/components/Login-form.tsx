...
const LoginForm = () => {
  ...
  return (
    <form className="ml-2 w-full md:w-[95%] h-[80%] flex flex-col items-center gap-3">
        <label className="w-full text-xl font-bold">Email:</label>
        <input type="email" title="Email" required className="w-[85%] h-10 border-blue-950 border-[1px] outline-none rounded-2xl text-xl pl-2"/>
        <label className="w-full text-xl font-bold">Password:</label>
        <section className="mb-2 w-full flex items-center justify-center">
            <input type={show? "text": "password"} title="Password" required className="w-[75%] h-10  border-blue-950 border-l-[1px] border-t-[1px] border-b-[1px]  outline-none rounded-l-2xl text-xl pl-2"/>
