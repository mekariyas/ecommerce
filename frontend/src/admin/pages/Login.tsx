...
const Login = () => {
  return (
    <section className="w-full h-[100vh] flex justify-center items-center overflow-hidden">
      <section className="w-full h-full md:w-[80%] md:h-[80%] md:shadow-2xl md:rounded-2xl md:shadow-black flex">
        ...
        <section className="w-full md:w-[50%] h-full">  
          <h1 className="mt-12 w-full h-12 text-center text-blue-950 text-2xl font-extrabold ">Login to Dashboard</h1>
          <LoginForm />
        </section>  
      </section> 
    </section>
