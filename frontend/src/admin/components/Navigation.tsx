...
const Navigation = ({...props}: state) => {
  ...
  return (
    <aside className={`${props.isVisible? "sm:flex" :"hidden"} flex-col items-center md:flex absolute z-[12] top-0 font-medium right-0 md:sticky w-[60%] h-[100vh] md:w-[15%] md:h-[90vh]  pt-4 text-lg md:text-xl border-[1px] border-black  bg-slate-950 text-white overflow-y-hidden`}>
